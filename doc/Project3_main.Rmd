...
# get SIFT feature
  #sift_feature_test <- read.csv("~/Documents/GitHub/Spring2018-Project3-Group5/output/SIFT_feature.csv",header = F)
...
if(run.test){
  ...
  write.csv(file='~/Documents/GitHub/Spring2018-Project3-Group5/output/best_test_model.csv', x=best_test_model)
}
...
#accuracy_test <- 1-mean(best_test_model != y_test)
