...
```{r train_label}
labels<-read.csv("../output/label_train.csv")
...
# get SIFT feature
  sift_feature_train <- read.csv("../output/SIFT_feature.csv",header = F)
...
# get SIFT feature
  #sift_feature_test <- read.csv("../output/SIFT_feature.csv",header = F)
...
# get RGB feature
  tm_feature_test <- system.time(rgb_feature_test <- feature(img_test_dir, 
        ...
        data_name="rgb", 
        export=TRUE))[3]
  saveRDS(rgb_feature_test, file="../output/feature_rgb_test.RData")
...
if(run.test){
  ...
  write.csv(file='../output/best_test_model_baseline.csv', x=base_test_model)
}
if(run.test){
  ...
  write.csv(file='../output/best_test_model_advanved.csv', x=best_test_model)
}
```
...
#accuracy_test <- 1-mean(best_test_model != label_test)
